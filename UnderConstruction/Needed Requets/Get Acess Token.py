...
cookies = {
    ...
    'JSESSIONID': '97656DA47C5967D7C6ED37FFB903D565-mc5.ebayk-worker029-dus1',
    '_gat': '1',
}
...
headers = {
    ...
    'X-Csrf-Token': 'c41e3601-f3dc-4c3b-8882-dc5414fad434',
    'Te': 'trailers',
    'Connection': 'close',
}

response = requests.get('https://www.ebay-kleinanzeigen.de/m-access-token.json', headers=headers, cookies=cookies, verify=False)
